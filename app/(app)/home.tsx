      ...
      <View className="space-y-8 animate-fade-in pb-20">
        ...
        <View className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <View>
            ...
            <Text className="text-3xl md:text-4xl font-extrabold tracking-tight dark:text-white">
          ...
          <View className="xl:col-span-3 space-y-10">
            ...
            <View>
              <View className="justify-between mb-4">
                <Text className="text-xl font-bold flex items-center gap-2 dark:text-white">
                    ...
                    >
                      ...
                      <View className="flex-1 min-w-0">
                        <View className="flex justify-between items-start mb-1.5">
                          <Text className="font-bold text-slate-900 text-sm leading-snug group-hover:text-primary transition-colors">
                            {topic.title}
                          </Text>
