    ...
    <Pressable
      ...
      <View className="mb-6 flex items-start justify-between flex-row w-full">
        ...
        <View className="rounded-full border border-slate-100 bg-slate-50 px-3 py-1 transition-colors group-hover:border-slate-200">
          <Text className="text-xs font-bold text-slate-500">{subject.totalLessons} Lessons</Text>
        </View>
      </View>
      ...
      <View className="mt-auto w-full">
        <View className="mb-2 flex justify-between   flex-row w-full">
          <Text className='text-slate-400 text-xs font-semibold'>Progress</Text>
          <Text className='text-slate-400 text-xs font-semibold'>{subject.progress}%</Text>
        </View>
